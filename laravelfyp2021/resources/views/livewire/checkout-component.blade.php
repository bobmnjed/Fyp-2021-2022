                ...
                <div class="summary-item payment-method">
                    ...
                    <div class="wrap-address-billing">
                        ...
                        <p class="row-in-form">
                            ...
                            <input  type="text" name="card-no" value="" placeholder="Crad Number" wire:model="card_no">
                        ...
                        <p class="row-in-form">
                            ...
                            @error('card_month') <span class="text-danger">{{$message}}</span> @enderror
                        </p>

                        <p class="row-in-form">
                            <label for="exp-year">Card Number:</label>
                            <input  type="text" name="exp-year" value="" placeholder="YYYY" wire:model="exp_year">
                            @error('exp_year') <span class="text-danger">{{$message}}</span> @enderror
                        </p>

                        <p class="row-in-form">
                            <label for="cvc">Card Verifcation Code:</label>
                    ...
                    <p class="summary-info grand-total"><span>Sub-Total</span> <span class="grand-total-price">${{Session::get('checkout')['subtotal']}}</span></p>
