                    ...
                    <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                        <div class="contact-box contact-form">
                            ...
                            <form name="frm-contact" wire:submit.prevent="sendMessage">
                                ...
                                <input type="text" value="" id="name" name="name" placeholder="Full Name" wire:model="name"/>
                                    
                                <label for="email">Email<span>*</span></label>
                                <input type="text" value="" id="email" name="email" placeholder="Email" wire:model="email"/>
                               

                                <label for="phone">Phone Number</label>
                                <input type="text" value="" id="phone" name="phone" placeholder="Phone Number" wire:model="phone"/>
                            ...
                            <div class="wrap-icon-box">
                                ...
                                <div class="icon-box-item">
                                    ...
                                    <div class="right-info">
                                        <b>Email</b>
                                        <p>ibrahimmonajjed997@gmail.com</p>
                                    </div>
                                </div>
